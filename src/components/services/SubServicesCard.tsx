...
export const SubServicesCard = ({ subService }: any) => {
  return (
    <div className="group w-[180px] h-[290px] max-h-[290px] rounded-lg bg-[#f3fbfb] flex flex-col items-center justify-around px-3 py-3 gap-1 cursor-pointer hover:bg-[#01d6d4] duration-700">
