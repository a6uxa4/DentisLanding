const SwitchContact = () => {
  return (
    <div className="w-[70px] h-[70px] bg-[#00d6d4] rounded-full fixed bottom-10 right-10 cursor-pointer flex items-center justify-center z-10">
      <div className="w-[70px] h-[70px] bg-[#00d6d4] opacity-60 rounded-full animate-ping absolute"></div>
      <svg
