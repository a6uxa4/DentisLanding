...
export const FeedbackCard = ({ feedback }: any) => {
  return (
    <div className="h-[350px] w-[650px] bg-white shadow-lg mx-10 rounded-xl relative cursor-pointer">
      <svg
      ...
      <div className="flex justify-between mx-[50px]">
        <div className="flex items-center mt-6">
          <div
            ...
            className={clsx(
              `rounded-full w-14 h-14  flex justify-center items-center`
            )}
          >
          ...
          <div className="ml-4 my-font">
            ...
            <p className="text-[13px] text-gray-600">{feedback.date}</p>
          </div>
        </div>
